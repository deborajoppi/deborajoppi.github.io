...
export const siteCopy = {
  en: {
    ...
    presentations: {
      ...
      intro:
        "Conference output is kept separate from peer-reviewed journal articles to avoid conflating abstracts, posters, talks, and seminars with full publications. Poster versus talk format is only shown when the source makes that distinction explicit.",
...
6,9.1`,
  ...
  pt: {
      ...
      education: [
        {
          ...
          institution: "Universidade de Gottingen, Alemanha",
          detail: "Tese: The Role of Polycomb Repressive Complexes 1 in Diffuse Large B-cell Lymphoma.",
        },
        {
          period: "2017-2019",
          degree: "Mestrado em Biomedicina",
          institution: "Karolinska Institutet, Suecia",
          detail: "Especializacao em biologia do cancer; tese sobre proteinas Id na morfogenese do foliculo piloso e da epiderme.",
        },
        {
          period: "2012-2017",
          degree: "Graduacao em Farmacia",
          institution: "Universidade Federal de Santa Catarina, Brasil",
          detail: "Incluiu periodo de intercambio academico na Columbia University em 2014.",
        },
      ],
      highlightsTitle: "Destaques",
      highlights: [
        "Formacao internacional em pesquisa na Amgen, University of Tokyo, University of Oxford e IFOM.",
        "Melhor Poster Cientifico, Karolinska Institutet (2019).",
        "Treinamento adicional em single-cell RNA-seq e analises computacionais de mRNA-seq, ChIP-seq e ATAC-seq.",
      ],
    },
    research: {
      title: "Pesquisa",
    ...
    presentations: {
      title: "Resumos em congressos e apresentacoes",
      intro:
        "A producao em congressos fica separada dos artigos de periodicos para nao confundir resumos, posters, palestras e seminarios com publicacoes completas. A distincao entre poster e apresentacao oral so aparece quando isso estiver explicito na fonte.",
      abstractsTitle: "Resumos publicados em anais de congressos",
      presentationsTitle: "Outras apresentacoes listadas no CV",
      linkLabel: "link",
      items: [
        {
          category: "abstract",
          ...
          authors: "Joppi, D. L., Loeber, J., Fanlo, L., Alcalde, Á., Javierre, B., Chapuy, B.",
          title: "Exploring the biological underpinnings of PRC1.1 deregulation in DLBCL",
          venue: "Clinical Epigenetics International Conference, Varsovia",
          href: "https://clinicalepigeneticsjournal.biomedcentral.com/articles/10.1186/s13148-024-01749-0",
        },
        {
          category: "presentation",
          ...
          authors: "Joppi, D. L., Loeber, J., Fanlo, L., Alcalde, Á., Javierre, B., Chapuy, B.",
          title: "Exploring the biological underpinnings of PRC1.1 deregulation in DLBCL",
          venue: "Apresentacao em congresso",
        },
        {
          category: "presentation",
          year: 2023,
        ...
        },
        {
          ...
          authors: "Joppi, D. L., Cisilotto, J., Mello Junior, L. J., Creczynski-Pasa, T. B.",
          title: "Evaluation of Antiproliferative Activity of Native Stingless Bees Propolis",
          venue: "1o Simposio do Programa de Pos-Graduacao em Farmacia da UFSC, Florianopolis",
        },
        {
          category: "presentation",
          year: 2018,
        ...
        },
        {
          ...
          authors: "Joppi, D. L., Cisilotto, J., Mello Junior, L. J., Creczynski-Pasa, T. B.",
          title: "Evaluation of Antiproliferative Activity of Native Stingless Bees' Propolis",
          venue: "Apresentacao em simposio",
        },
        {
          category: "abstract",
          year: 2013,
          authors: "Joppi, D. L., Cisilotto, J., Creczynski-Pasa, T. B.",
          title: "Extrato de Propolis de Abelhas Indigenas Sem Ferrao Induzem Apoptose em Linhagens de Melanoma",
          venue: "II Seminario da Rede Nanofito/CAPES, Florianopolis",
        },
        {
          category: "abstract",
          year: 2013,
          authors: "Joppi, D. L., Cisilotto, J., Creczynski-Pasa, T. B.",
          title: "Atividade citotoxica de propolis de abelhas sem ferrao Scaptotrigona bipunctata (Tubuna) e Melipona quadrifasciata (Mandacaia) em celulas de melanoma",
          venue: "III Workshop de Materiais Aplicados a Fisica e Farmacia, Rio dos Cedros",
        },
        {
          category: "presentation",
          year: 2013,
          authors: "Joppi, D. L., Cisilotto, J., Creczynski-Pasa, T. B.",
          title: "Atividade citotoxica de abelhas sem ferrao Scaptotrigona bipunctata (Tubuna) e Melipona quadrifasciata (Mandacaia) em celulas de melanoma",
          venue: "Apresentacao em seminario",
        },
        {
          category: "presentation",
          year: 2013,
